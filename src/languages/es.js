...
export default {
    ...
    bankAccount: {
        headerTitle: 'Conecta su cuenta bancaria',
        subtitle: '¡Prepárese para los pagos sin conductor!',
        description: 'Puede emitir tarjetas corporativas, reembolsar gastos, cobrar facturas y pagar facturas, todo desde la misma cuenta bancaria. Para su comodidad y seguridad, utilizamos Plaid para facilitar la conexión en línea. ¡Vamos!',
        connectWithPlaid: 'Conéctese en línea con Plaid',
