...
export default {
    ...
    bankAccount: {
        ...
        description: 'You can issue corporate cards, reimburse expenses, collect invoices, and pay bills all from the same bank account.  For your convenience and security, we use Plaid to facilitate the connection online.  Let\'s go!',
        connectWithPlaid: 'Connect online with Plaid',
